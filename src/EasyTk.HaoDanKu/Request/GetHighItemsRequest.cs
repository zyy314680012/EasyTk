...
namespace EasyTk.HaoDanKu.Request
{
    ...
    /// 高佣专场商品API
    /// </summary>
    public class GetHighItemsRequest : BaseRequest<WrapperResponse<List<GetHighItemsResponse>>>
    {
        public override string GetApiUrl() => "http://v2.api.haodanku.com/get_highitems";
