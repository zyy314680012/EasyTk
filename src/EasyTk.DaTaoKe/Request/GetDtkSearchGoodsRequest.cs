...
{
    public class GetDtkSearchGoodsRequest:BaseRequest<WrapperResponseList<GetDtkSearchGoodsResponse>>
    {
        public override string GetApiUrl() => "https://openapi.dataoke.com/api/goods/get-dtk-search-goods";

        public override string Version => "v2.1.2";
