...
namespace EasyTk.DaTaoKe.Request.DouYin
{
    /// <summary>
    /// 抖音一分购商品
    /// https://www.dataoke.com/kfpt/api-d.html?id=113
    /// </summary>
    public class OneFenGoodsListRequest : BaseRequest<WrapperResponseDouYinTotal<OneFenGoodsListResponse>>
    {
        public override string GetApiUrl() => "https://openapi.dataoke.com/api/tiktok/tiktok-one-fen-goods-list";
        ...
        /// <summary>
        /// title string 否 商品标题，从1分购商品中返回标题中包含某个关键词的商品
        /// </summary>
        [JsonProperty("title")]
