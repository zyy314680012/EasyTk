...
{
    public class OneFenGoodsListResponse
    {
        #region
        ...
        /// <summary>
        /// newUserPrice number 0.01 抖音支付新用户价（单位：元)
        /// </summary>
        [JsonProperty("newUserPrice")]
        public double? NewUserPrice { get; set; }

        /// <summary>
        /// discountDesc string 满20减1 券金额
        /// </summary>
        ...
        /// <summary>
        /// detailUrl string https://haohuo.jinritemai.com/views/product/item2?id=3531455712288976723\u0026pick_source=NAr9W5y 商品链接
        /// </summary>
