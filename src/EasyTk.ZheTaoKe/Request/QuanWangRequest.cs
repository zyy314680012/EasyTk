...
namespace EasyTk.ZheTaoKe.Request
{
    public class QuanWangRequest : BaseRequest<BaseResponseContainer<QuanWangResponse[]>>
    {
        ...
        ///<summary> 
        ///sort string	否	商品排序方式，new：按照综合排序，sale_num_asc：按照月销量从小到大排序，sale_num_desc：按照月销量从大到小排序，commission_rate_asc：按照佣金比例从小到大排序，commission_rate_desc：按照佣金比例从大到小排序，price_asc：按照价格从小到大排序，price_desc：按照价格从大到小排序。
        ///</summary>
        [JsonProperty("sort")]
