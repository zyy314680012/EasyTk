...
{
    public class PddDdkTopGoodsListQueryResponse : BaseResponse<PddDdkTopGoodsListQueryResponse.PddDdkTopGoodsListQueryData>
    {
        /// <summary>
        /// response
        /// </summary>
        [JsonProperty("top_goods_list_get_response")]
        public override PddDdkTopGoodsListQueryData Data { get; set; }

        public class PddDdkTopGoodsListQueryData : BaseResponseData
        {
            /// <summary>
            /// 商品列表
            /// </summary>
            [JsonProperty("list")]
            public PddDdkTopGoodsListQueryDataItem[] List { get; set; }
        ...
        public class PddDdkTopGoodsListQueryDataItem
        {
            /// <summary>
            /// 商品类目id
            /// </summary>
