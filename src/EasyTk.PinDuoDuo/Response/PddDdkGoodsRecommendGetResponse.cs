...
{
    public class PddDdkGoodsRecommendGetResponse : BaseResponse
    {
        /// <summary>
        /// goods_basic_detail_response
        /// </summary>
        [JsonProperty("goods_basic_detail_response")]
        public PddDdkGoodsRecommendGetData GoodsBasicDetailResponse { get; set; }

        public class PddDdkGoodsRecommendGetData : BaseResponse
        {
            /// <summary>
            /// 列表
            /// </summary>
