...
{
    public class PddDdkGoodsSearchResponse : BaseResponse<PddDdkGoodsSearchResponse.GoodsSearchResponseData>
    {
        /// <summary>
        /// response
        /// </summary>
        [JsonProperty("goods_search_response")]
        public override GoodsSearchResponseData Data { get; set; }

        public class GoodsSearchResponseData : BaseResponseData
        {
            /// <summary>
            /// 商品列表
            /// </summary>
            [JsonProperty("goods_list")]
            public GoodsSearchResponseDataItem[] GoodsList { get; set; }
        ...
        public class GoodsSearchResponseDataItem
        {
            /// <summary>
            ...
            public long? MallCouponDiscountPct { get; set; }
            ...
            public long? MallCouponMaxDiscountAmount { get; set; }

            /// <summary>
            /// 最小使用金额
            /// </summary>
            [JsonProperty("mall_coupon_min_order_amount")]
            public long? MallCouponMinOrderAmount { get; set; }
