...
namespace EasyTk.PinDuoDuo.Response
{
    public class PddDdkMerchantListGetResponse : BaseResponse
    {
        ...
        public class PddDdkMerchantListGetData : BaseResponseData
        {
            ...
            public PddDdkMerchantListGetDataItem[] MallSearchInfoVoList { get; set; }
        ...
        public class PddDdkMerchantListGetDataItem
        {
            /// <summary>
            /// 商品类目列表
            /// </summary>
            [JsonProperty("cat_id_list")]
            public long[] CatIdList { get; set; }
            ...
            public GoodsDetailVo[] GoodsDetailVoList { get; set; }
            ...
            public MallCouponInfo[] MallCouponInfoList { get; set; }
