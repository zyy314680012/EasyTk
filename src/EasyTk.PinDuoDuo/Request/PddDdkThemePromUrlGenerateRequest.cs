...
namespace EasyTk.PinDuoDuo.Request
{
    ...
    /// 多多进宝主题推广链接生成
    /// </summary>
    public class PddDdkThemePromUrlGenerateRequest : BaseRequest<PddDdkThemePromUrlGenerateResponse>
    {
        public override string Type => "pdd.ddk.theme.prom.url.generate";
