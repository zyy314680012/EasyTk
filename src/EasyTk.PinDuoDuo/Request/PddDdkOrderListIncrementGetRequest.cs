...
namespace EasyTk.PinDuoDuo.Request
{
    ...
    /// 最后更新时间段增量同步推广订单信息
    /// </summary>
    public class PddDdkOrderListIncrementGetRequest : BaseRequest<PddDdkOrderListIncrementGetResponse>
    {
        public override string Type => "pdd.ddk.order.list.increment.get";
